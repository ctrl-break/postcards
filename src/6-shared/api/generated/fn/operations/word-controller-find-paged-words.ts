...
export function wordControllerFindPagedWords(http: HttpClient, rootUrl: string, params: WordControllerFindPagedWords$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<WordDto>>> {
