...
export function usageControllerFindUserWordUsages(http: HttpClient, rootUrl: string, params: UsageControllerFindUserWordUsages$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<WordUsageDto>>> {
