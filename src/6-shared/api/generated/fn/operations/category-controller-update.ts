...
export function categoryControllerUpdate(http: HttpClient, rootUrl: string, params: CategoryControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<CategoryDto>> {
