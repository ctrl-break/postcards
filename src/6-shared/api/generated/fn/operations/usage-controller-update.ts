...
export function usageControllerUpdate(http: HttpClient, rootUrl: string, params: UsageControllerUpdate$Params, context?: HttpContext): Observable<StrictHttpResponse<WordUsageDto>> {
