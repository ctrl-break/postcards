...
export function authControllerRefreshTokens(http: HttpClient, rootUrl: string, params?: AuthControllerRefreshTokens$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
