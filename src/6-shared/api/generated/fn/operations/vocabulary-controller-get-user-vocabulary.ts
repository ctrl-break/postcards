...
export function vocabularyControllerGetUserVocabulary(http: HttpClient, rootUrl: string, params?: VocabularyControllerGetUserVocabulary$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<VocabularyDto>>> {
