...
export function imageControllerCreate(http: HttpClient, rootUrl: string, params: ImageControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<ImageDto>> {
