...
export function vocabularyControllerCreate(http: HttpClient, rootUrl: string, params: VocabularyControllerCreate$Params, context?: HttpContext): Observable<StrictHttpResponse<VocabularyDto>> {
