...
export function categoryControllerFindBasicCategories(http: HttpClient, rootUrl: string, params?: CategoryControllerFindBasicCategories$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CategoryDto>>> {
