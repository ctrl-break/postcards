...
export function vocabularyControllerFindOne(http: HttpClient, rootUrl: string, params: VocabularyControllerFindOne$Params, context?: HttpContext): Observable<StrictHttpResponse<VocabularyDto>> {
